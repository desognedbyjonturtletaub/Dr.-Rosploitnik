...
<br/>
[``lelogint``](https://github.com/lelogint)   - Script Programmer (.lua/.luau), Ui Design, Art assets
<br/>
[``Eclipse<h2``](https://github.com/Eclipse-h2)   - Website Dev (.html/.css/.jss), Ui Design, Sound assets
<br>
<h2>Previews:</h2>
